...
// 2. Sign up at https://resend.com, verify a sending domain (or use their
//    shared onboarding domain for testing), and create an API key.
// 3. In your Vercel project settings, add an environment variable:
//      RESEND_API_KEY = re_xxxxxxxxxxxxx
//    Then redeploy (env vars only apply to new deployments).
// 4. Update FROM_EMAIL and TO_EMAIL below.
